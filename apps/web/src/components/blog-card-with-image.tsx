  ...
  return (
    ...
    >
      <CardBody className="p-0 " placeholder="" onPointerEnterCapture={() => {}} onPointerLeaveCapture={() => {}}>
        ...
        <Typography variant="h3" className="leading-[45px] mb-4 !text-gray-900" placeholder="" onPointerEnterCapture={() => {}} onPointerLeaveCapture={() => {}}>
          How to Build a $24 Billion Dollar Company in Just 2 Years.
        </Typography>
        <Typography className="font-normal mb-4 !text-base text-gray-500 " placeholder="" onPointerEnterCapture={() => {}} onPointerLeaveCapture={() => {}}>
